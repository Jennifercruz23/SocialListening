// src/lib.rs
/*
 * Core library for SocialListening
 */
...
#[derive(Debug)]
pub struct SocialListeningProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SocialListeningProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SocialListening processing");
    
    let mut processor = SocialListeningProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SocialListeningProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SocialListeningProcessor::new(false);
